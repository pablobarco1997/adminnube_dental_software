...
<?php
 ...
 $paciente = $conf->ObtenerPaciente($db, $idPaciente, true);
...
<div class="form-group col-xs-12 col-md-12">
    ...
    <div class="row">
        <div class="col-md-12">
            NOMBRE Y APELLIDO
            <input type="text" class="form-control input-sm" name="doc_nombre_apellido" id="doc_nombre_apellido" value="<?= $paciente->nombre .' '. $paciente->apellido ?>">
        </div>
    </div>

    <div class="row">
        <div class="col-md-6">CEDULA/PASAPORTE <input type="text" class="form-control input-sm" name="doc_cedula" id="doc_cedula" value=" <?= $paciente->rut_dni ?>"></div>
    ...
    <div class="row">
        <div class="col-md-3">
            SEXO:&nbsp;
            <div class="checkbox"><label><input type="radio" id="radioMasculino" name="sexo"  value="masculino" <?= ($paciente->sexo == "masculino") ? "checked" : "" ?>  >&nbsp;Masculino</label></div>
        </div>
        <div class="col-md-3">
            &nbsp;
            <div class="checkbox"><label><input type="radio" id="radioFemenino" name="sexo" value="femenino" <?= ($paciente->sexo == "femenino") ? "checked" : "" ?>  >&nbsp;Femenino</label></div>
        </div>
        <div class="col-md-3">EDAD <input type="text" class="form-control input-sm" id="doc_edad" value=" <?php echo  (int)( (int)date('Y') - (int)( date('Y' , strtotime($paciente->fecha_nacimiento) ) ) ) ?> "></div>
        <div class="col-md-3">OCUPACIÓN <input type="text" class="form-control input-sm" id="doc_ocupacion"></div>
    </div>

    <div class="row">
        <div class="col-md-12">DIRECCIÓN DE DOMICILIO <input type="text" class="form-control input-sm" id="doc_domicilio" value="<?= $paciente->direccion ?>"></div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            CELULAR
            <input type="text" class="form-control input-sm" id="doc_celular" value="<?= $paciente->telefono_movil ?>">
        </div>
    </div>
